...
public class CustomerTbl  implements java.io.Serializable {
    ...
    public CustomerTbl(int customerId, OrderTbl orderTbl, String customerName, String customerAddress, String email, int creditCardno, Date dob, Set shoppingCartTbls) {
       this.customerId = customerId;
