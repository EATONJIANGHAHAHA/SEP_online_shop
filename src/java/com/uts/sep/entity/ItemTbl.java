...
public class ItemTbl implements Serializable {
    ...
    public ItemTbl(/*int itemId,*/ String itemName, String itemDescription, int stock, int itemStatus, double price, String itemImage, int ownerId/*, Set orderDetailTbls*/) {
